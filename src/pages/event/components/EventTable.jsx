...
const displayColumns = ['Unique ID', 'Title', 'Feature Image', 'Establishment', 'Free Entry', 'Price', 'Start Date', 'End Date'];
const EventTable = ({ onDelete, onEdit, events, loading, hightLightText }) => {
